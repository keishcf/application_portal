...
from apply.models import ApplicantAcademicBackground, ApplicantDocument, ApplicantExtracurricularActivity, ApplicantPersonalInformation, UserApplication
...
class AcademicBackgroundForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'degree': forms.Select(attrs={'class': 'py-3 px-4 pe-9 block w-full border-gray-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none'}, choices=ApplicantAcademicBackground.DEGREE_CHOICES),
        }
        labels = {
...
class DocumentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'transcript': forms.FileInput(attrs={"accept": "application/pdf"}),
        }
        labels = {
            'cv': 'Upload Your CV',
